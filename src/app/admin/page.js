  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-10">
          <h1 className="text-3xl sm:text-4xl font-bold text-[#2B3F43]">Admin Dashboard</h1>
          <p className="mt-2 text-gray-600">Manage your MDCAT website content from one place.</p>
        </div>
          ...
          {pages.map((page) => {
            ...
            return (
              ...
              >
                ...
                <h2 className="text-xl sm:text-2xl font-bold text-white">{page.name}</h2>
                <p className="mt-2 flex-grow text-sm text-gray-300">{page.description}</p>
